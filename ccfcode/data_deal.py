...
def load_word_vev(path,word2idx=None):
...
class ABSADatesetReader:
        ...
        for i, row in enumerate(f_csv):
            if i == 0:
                ...
                for entity in entities:
                    ...
                    bert_text_indices = bert_tokenizer.text_to_sequence('[CLS]') + _text_indices +                          bert_tokenizer.text_to_sequence('[SEP]') + _aspect_indices + bert_tokenizer.text_to_sequence('[SEP]')
    ...
    def __init__(self, dataset='finance', embed_dim=300):
        ...
        fname = {
            'finance': {
                'train': '../ccfdata/Clean_Train_Data.csv',
                'test': '../ccfdata/Clean_Test_Data.csv'
            },
        }
